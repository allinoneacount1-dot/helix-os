      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-space-grotesk)] text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4">
            Your{" "}
            <span className="text-gradient">Intelligence Galaxy</span>
          </h2>
              ...
              >
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                    selectedNode === node.id ? "scale-125" : ""
                  } ${pulseIndex === i ? "animate-pulse" : ""}`}
                  style={{
            ...
            <div className="glass rounded-xl p-4 flex-1">
              ...
              <div className="space-y-2">
                {(searchQuery ? searchResults.filter((r) =>
                  ...
                  <button
                    key={i}
                    className="w-full text-left p-3 rounded-lg hover:bg-white/[0.02] transition-colors group"
                  >
                    <div className="flex items-center justify-between mb-1">
